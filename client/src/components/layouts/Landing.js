        ...
        <div className="container">
          <div className="row center-xs center-sm center-md center-lg middle-xs middle-sm middle-md middle-lg">
            <div className="showcase col-xs-10 col-sm-10 col-md-10 col-lg-10">
              ...
              <p>A website where you can conduct and attempt quizzes.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="row center-xs center-sm center-md center-lg">
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              ...
              <p>
                You can attempt any quiz, based on your performance you'll get
                your marks.
              </p>
            </div>
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              ...
              <h3>Leader Board</h3>
              <p>
                You can check the leader-board to know how well you performed
                compared to others.
              </p>
            </div>
          </div>

      ...
      <section id="page" className="classes">
        <div className="container">
          <div className="row center-xs center-sm center-md center-lg middle-xs middle-sm middle-md middle-lg">
            ...
            <input
              className="col-inp col-xs-10 col-sm-10 col-md-10 col-lg-10"
              type="text"
              value={quizName}
          ...
          <div className="row center-xs center-sm center-md center-lg middle-xs middle-sm middle-md middle-lg">
            ...
            />
            <input
              className="col-inp col-xs-1 col-sm-1 col-md-1 col-lg-1"
              type="number"
              value={marks === 0 ? "" : marks}
              placeholder="Marks"
            ...
            {options.map((option) => (
              <Fragment key={uuidv4()}>
                <div className="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div
                    className={`${
                      option === correctAns ? "cor-ans" : ""
                    } row center-xs center-sm center-md center-lg middle-xs middle-sm middle-md middle-lg`}
                  >
                    <div className="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                      {option}
                    </div>
                    <div
                      className="col-del col-xs-1 col-sm-1 col-md-1 col-lg-1"
                      onClick={() => {
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div className="row center-xs center-sm center-md center-lg middle-xs middle-sm middle-md middle-lg">
                <input
                  className="col-inp col-xs-8 col-sm-8 col-md-8 col-lg-8"
                  type="text"
